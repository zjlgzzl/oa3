...
public interface BusinService {
    ...
    public void saveEntity(TBusin var1, List<TContainer> var2, List<TService> var3, List<TCost> var4, List<TCost> var5, List<TCash> var6, int[] var7, String[] var8, Map<Integer, String> map) throws Exception;
    ...
    public void saveCash(int var1, List<TContainer> var2, List<TCost> var3, List<TCost> var4, List<TCash> var5, List<TCashRate> var6, List<TCash> var7, List<TCashRate> var8, short var9, short var10, TBusin var11, String[] var12,Map<Integer, String> map) throws Exception;
