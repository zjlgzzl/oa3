...
public interface FinanceService {
    ...
    public void saveEntity(TFinance var1, List<TFinanceDetail> var2) throws Exception;
    ...
    public void updateArchiveflag(int[] var1, short var2) throws Exception;

	public void updateRecover(TFinance finance) throws Exception;
}
