 ...
 *  com.common.entity.VBusinInvUserId
 */
...
implements Serializable {
    ...
    public VBusinInvUserId() {
    }

    public VBusinInvUserId(Integer businId, Integer cusid, Integer eid) {
        this.businId = businId;
        this.cusid = cusid;
        this.eid = eid;
    }

    public VBusinInvUserId(Integer businId, String ccode, Integer cusid, String cusName, Integer eid, String ename, Timestamp createdate) {
        this.businId = businId;
        this.ccode = ccode;
        this.cusid = cusid;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof VBusinInvUserId)) {
            return false;
        }
        VBusinInvUserId castOther = (VBusinInvUserId)other;
