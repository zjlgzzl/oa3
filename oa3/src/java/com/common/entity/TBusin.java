...
implements Serializable {
	...
	public String getCPickupStatus() {
		return CPickupStatus;
	}

	public void setCPickupStatus(String cPickupStatus) {
		CPickupStatus = cPickupStatus;
	}
