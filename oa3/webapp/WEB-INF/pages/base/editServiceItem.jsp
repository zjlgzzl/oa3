  			...
  			<div class="edit">
  				<form id="editForm" action="${ctx}/sitem/SaveServiceItem.action" method="post">
  					<div>
			           	...
			           	<select id="typeid" name="sitem.TServiceType.CId" class="border" style="width:200px;">
			        ...
			        <div>
			           	<label><span style="color:red;">*</span>服务项目名称</label>
			        ...
			        <div>
			           	...
			           	<textarea id="remarks" name="sitem.CRemarks" rows="5" cols="10">${requestScope.sitem.CRemarks}</textarea>
			        </div>
