  				...
  				<form id="editForm" action="${ctx}/cus/UpdateCus.action" method="post">
			        <div>
			        	<label>Client Khmer name</label>
	  					<input name="cus.COther1" value="${requestScope.cus.COther1}" 
	  							type="text" class="field border" style="width:60px;" disabled="disabled"/>
			        ...
			        <div style="padding-left:86px;">
			           ...
			           <input name="cus.COther7" value="${requestScope.cus.saler.CName}"
			           			type="text" class="field border" disabled="disabled"/>
			        </div>
			        <div style="padding-left:86px;">
			        	<label>VAT No.</label>
