...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div class="right">
  		<div class="right_1">
			<form id="queryForm" action="${ctx}/acc/AccItemList.action" method="post">
					<table style="width:600px; margin-left:0;">
						<tr>
		  					<td style="width:100px;">财务科目名称</td>
       	...
       	<div class="right_2">
       		<a href="${ctx}/acc/AddAccItem.action" style="margin-left:780px;">添加</a>
        </div>
        <div class="right_3">
	        <table id="table1" class="table">
	           	<tr>
	               	<th style="width:40px;">序号</th>
	               	<th style="width:200px;">财务科目名称</th>
	               	<th style="width:100px;">状态</th>
	               	<th style="width:250px;">备注 </th>
	                <th style="width:210px;">操作</th>
	            </tr>
	            <s:iterator value="#request.accList" var="accList" status="num">
	            <tr>
					...
					<td>
						<s:if test="(CState == 1) && (CCreateUserid==#session.userID)">
							<a href="${ctx}/acc/EditAccItem.action?accId=<s:property value="CId"/>">修改</a>
							<a href="${ctx}/acc/DeleteAccItem.action?accId=<s:property value="CId"/>"
								onclick="return confirmDel();">删除</a>
							<!--  
							<a href="${ctx}/acc/InvalidAccItem.action?accId=<s:property value="CId"/>"
								onclick="return confirmInvalid();">禁用</a>
							-->
						</s:if>
						<a href="${ctx}/acc/ViewAccItem.action?accId=<s:property value="CId"/>">查看</a>
					</td>
				</tr>
	            </s:iterator>
	       </table>
