...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/cus/UpdateCus.action" method="post">
  					<div>
	  					...
	  					<input name="cus.COther1" value="${requestScope.cus.COther1}" type="text" class="field border" style="width:60px;"/>
			           	...
			           	<input id="CId" name="cus.CId" value="${requestScope.cus.CId}" type="hidden" />
						<input id="CCreateUserid" name="cus.CCreateUserid" value="${requestScope.cus.CCreateUserid}" type="hidden" />
			           	<input id="CCreateDate" name="cus.CCreateDate" value="${requestScope.cus.CCreateDate}" type="hidden" />
			           	<input id="CState" name="cus.CState" value="${requestScope.cus.CState}" type="hidden" />
			           	
			           	
			           	<input name="cus.CLastUserid" value="${requestScope.cus.CLastUserid}" type="hidden" />
			           	<input name="cus.CLastDate" value="${requestScope.cus.CLastDate}" type="hidden" />
			           	<input name="cus.CBlack" value="${requestScope.cus.CBlack}" type="hidden" />
			        ...
			        <div style="padding-left:86px;">
			        	...
			        	<option value="">PLEASE CHOOSE</option>
			        		<c:forEach items="${salerList }" var="saler">
			        			<option value="${saler.CId }" <c:if test="${saler.CId == cus.salerId }">selected</c:if>>${saler.CName }</option>
			        		</c:forEach>
			        	</select>
			        </div>
			        <div style="padding-left:86px;">
