...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/btype/UpdateBusinType.action" method="post">
			        <div>
			           	...
			           	<input id="CId" name="businType.CId" value="${requestScope.businType.CId}" type="hidden" />
						<input id="CCreateUserid" name="businType.CCreateUserid" value="${requestScope.businType.CCreateUserid}" type="hidden" />
			           	<input id="CCreateDate" name="businType.CCreateDate" value="${requestScope.businType.CCreateDate}" type="hidden" />
			           	<input id="CState" name="businType.CState" value="${requestScope.businType.CState}" type="hidden" />
