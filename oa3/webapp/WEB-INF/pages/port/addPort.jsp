...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		//返回
		function returnList(){
			document.getElementById("editForm").action = "${ctx}/port/PortList.action";
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/port/SavePort.action" method="post">
	  				<div>
			           	<label><span style="color:red;">*</span>港口</label>
