  ...
  <body>
  	<div id="mainContent">
  		<div class="right" style="margin-top:30px;">
  			<form id="editForm" action="${ctx}/emp/SaveEmp.action" method="post">
	  			...
	  			<table class="editTab" style="margin-top:15px; width:680px;">
	  				<tr>
						...
						<td class="content" style="width:120px;">
							<select id="deptid" name="emp.TDept.CId" class="border" style="width:120px;">
	  				...
	  				<tr style="margin-top:15px;">
	  					...
	  					<td class="content" style="width:120px;">
	  						<select id="CGender" name="emp.CGender" class="border" style="width:120px;">
	  					...
	  					<td class="content" style="width:120px;">
	  						<input type="radio" name="emp.CManageflag" value="0" checked="checked" 
	  								style="margin-left:10px; margin-right:10px;" />否
				           	<input type="radio" name="emp.CManageflag" value="1" 
				           			style="margin-left:30px; margin-right:10px;" />是
	  					</td>
	  				</tr>
	  				<tr style="margin-top:15px;">
	  					<td class="title" style="width:100px;">
	  					...
	  					<td class="content" colspan="5" style="width:600px;">
	  						<textarea id="remarks" name="emp.CRemarks" 
	  									rows="2" cols="10" style="width:600px;margin-top:5px;">${requestScope.emp.CRemarks}</textarea>
	  					</td>
	  				</tr>
	  			</table>
	  			...
	  			<table class="editTab" style="margin-top:15px; width:610px;">
	  				<tr>
	  					<td class="title" style="width:68px;">
	  						<label><span style="color:red;">*</span>登陆账号</label>
	  					</td>
	  					<td class="content" style="width:120px;">
	  						<input id="CUsername" name="user.CUsername" value="${requestScope.user.CUsername}"
				           			type="text" class="field border onlyNumAlpha" />
	  					</td>
	  			...
	  			<table class="editTab" style="margin-top:10px; margin-left:20px; width:1560px;">
	  				<tr>
						...
						<s:if test="#session.topRoleList[#num.index].clevel == 1">
							<tr>
								<td style="width:40px; text-align:center;">
									<input type="checkbox" id="<s:property value="funid" />" 
											...
											onclick="topRole(<s:property value="funid" />)"/>
								</td>
							...
							<tr>
								...
								<s:iterator value="#session.subRoleList" var="subRoleList" status="num2">
									<s:if test="(#session.subRoleList[#num2.index].clevel == 2) && 
												(#session.subRoleList[#num2.index].uppid == #session.topRoleList[#num.index].funid) &&
												(#session.subRoleList[#num2.index].funid != 215)">
										<td style="width:40px; text-align:center;">
											<input type="checkbox" id="<s:property value="funid"/>" 
													name="role" value="<s:property value="funid"/>" 
													onclick="subRole(<s:property value="funid"/>)"/>
										</td>
	  			...
	  			<div style="margin-bottom:20px;">
	  				<input type="submit" value="保存" class="save" style="width:60px;height:20px;margin-left:600px;" onclick="return check();"/>
