...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		//返回
		function returnList(){
			document.getElementById("editForm").action = "${ctx}/busin/FinanceAuditList.action";
		...
		function AuditY(){
			if (confirm("确认审核通过？")){
				document.getElementById("editForm").action = "${ctx}/busin/FinanceAuditBusinY.action";
				document.getElementById("editForm").submit();
			}
		}
		...
		function AuditN(){
			if (confirm("确认审核不通过？")){
				document.getElementById("editForm").action = "${ctx}/busin/FinanceAuditBusinN.action";
				document.getElementById("editForm").submit();
			}
		}
