				...
				<table style="margin-top:20px;width:676px;margin-left:10px;">
					...
					<tr>
						...
						<td style="font-weight:bold;">
							$<fmt:formatNumber pattern="#,##0.00" value="${busin.CRecieveMoney2}"></fmt:formatNumber>
							<input type="hidden" value="${busin.CRecieveMoney2}" id="CRecieveMoney"/>
						</td>
					</tr>
					<tr>
