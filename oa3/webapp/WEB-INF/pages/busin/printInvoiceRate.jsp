  			...
  			<form id="editForm" action="${ctx}/busin/FinanceCost.action" method="post">
  				...
  				<div style="margin-left:2px; width:666px; margin-top:190px;">
  						<div style="margin-top:30px;text-align:center;">
	  						<span style="color:black; font-size:20px; font-family:'Khmer OS Battambang'; text-decoration:underline">
								វិក្កយបត្រអាករ
							</span>
	  					</div>
	  					<div style="margin-top:10px;text-align:center;">
	  						<span style="color:black; font-size:16px; text-decoration:underline">
								TAX INVOICE
							</span>
	  					</div>
	  					<div class="clear"></div>
				...
				<table id="" class="table" style="margin-top:10px; margin-left:2px; width:666px; color:black; border:0px;" >
					<tr>
						...
						<td style="width:185px;height:0px;border:0px;"></td>
					</tr>
					<tr>
						<td style="border:0px;text-align:left;padding-left:10px;" colspan="5">
					...
					<tr>
						<td style="border:0px;text-align:left;padding-left:10px;" colspan="5">
							...
							អតិថិជន<span style="font-size:12px; font-weight:bold;">:</span>
							</span>
							<input style="border:0px;width:300px;font-size:12px;"/>
						</td>
						<td style="border:0px;text-align:left;">
						</td>
						<td style="border:0px;text-align:center;">
				...
				<table id="costMoney" class="costTable" style="margin-top:25px; width:620px; border:1px solid black; color:black; margin-left:10px; float:left;">
					<tr>
						...
						<th style="width:210px;font-size:14px;font-weight:normal;border:1px solid black;height:18px;
									border-bottom:0px;">បរិយាយ</th>
						<th style="width:30px;font-size:14px;font-weight:normal;border:1px solid black;height:18px;
					...
					<tr>
						<th style="border:1px solid black;height:14px;font-weight:normal;border-top:0px;">Item No.</th>
				...
				<table class="costTable" style="margin-top:2px; width:620px; color:black; margin-left:10px; border-top:0px;">
					<tr>
						<td style="width:273px;border-top:0px;"></td>
						<td style="width:113px;border-top:0px;font-weight:bold;"><span style="font-size:16px;">សរុប</span>/Total:</td>
						<td style="width:80px;border-top:0px;font-weight:bold;">
							<div id="amount"></div>
						</td>
						<td style="width:80px;border-top:0px;font-weight:bold;">
							<div id="vat"></div>
				...
				<table style="width:666px; margin-left:10px; margin-top:10px;">
					<tr>
