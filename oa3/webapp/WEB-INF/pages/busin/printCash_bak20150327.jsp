  		...
  		<div class="right">
  			<form id="editForm" action="${ctx}/busin/FinanceCost.action" method="post">
  				<input type="hidden" name="businId" value="${requestScope.busin.CId}" />
  					...
  					<s:if test="#request.cashUserCount > 0">
  					
						<s:iterator value="#request.cashUserList" var="cashUserList" status="num">
							...
							<table id="costMoney<s:property value="#num.index" />" class="costTable" style="width:620px; border:1px solid black; margin-top:20px; color:black; margin-left:10px; float:left;">
								<tr>
								...
								<tbody id="cashDetail">
									<s:iterator value="#request.cash" var="cash" status="cashNum">
										<s:if test="#request.cashUserList[#num.index].userid == #request.cash[#cashNum.index].TUserByCUserid.CId">
							...
							<div class="clear"></div>
							<div id="totalDollars<s:property value="#num.index" />" style="margin-left:10px; margin-top:30px; font-weight:bold;">
							</div>
