...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		function returnList(){
			...
			document.getElementById("editForm").action = "${ctx}/busin/BusinArchivingList.action";
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
			<form id="editForm" action="${ctx}/busin/UpdateArchiving.action" method="post">
				...
				<table id="mainTable" class="table" style="margin-top:0px; width:1025px; margin-left:5px; color:black;">
					<tr>
						...
						<td style="width:150px;">
							...
							<!--  
							<input type="hidden" name="busin.CCashDate" value="${requestScope.busin.CCashDate}" />
							-->
						</td>
						<td style="width:100px;">
				...
				<table id="costTable" class="table" style="margin-top:0px; width:1220px; margin-left:5px; color:black;">
					<tr id="costTR0">
						...
						<td style="width:96px;">
							<s:if test=" (costs[0].TCostGroup != null && costs[0].TCostGroup.CId != null && costs[0].TCostGroup.CId > 0) ||
											(#session.fun211 == 1 && (#request.costsSize == 0 || costs[0].TCostItem == null || 
											(costs[0].TCostItem.CId != 198 && costs[0].TCostItem.CId != 199)))">
						...
						<td style="width:113px;">
							<s:if test=" (costs[0].TCostGroup != null && costs[0].TCostGroup.CId != null && costs[0].TCostGroup.CId > 0) ||
								...
								<input type="text" id="CRe0"
										...
										class="field border" style="width:110px;"/>
							</s:if>
							<s:else>
								<input type="text" id="CRe0"
										value="${requestScope.costs[0].CRe}"
										class="" style="width:110px;border:0px;" disabled="disabled"/>
								<input type="hidden"
										name="costs[0].CRe"
										value="${requestScope.costs[0].CRe}"
										class="field border"/>
						...
						<s:iterator value="#request.costs" var="costs" status="cnum">
							<s:if test="#cnum.index > 0">
								<tr id="costTR<s:property value="#cnum.index" />">
									...
									<td>
										<s:if test="(costs[#cnum.index].TCostGroup != null && costs[#cnum.index].TCostGroup.CId != null && costs[#cnum.index].TCostGroup.CId > 0) ||
													((#session.fun211 == 1) && 
													(costs[#cnum.index].TCostItem == null || 
													 (costs[#cnum.index].TCostItem.CId != 198 && costs[#cnum.index].TCostItem.CId != 199)))">
				...
				<table class="table" style="margin-top:2px; width:1025px; margin-left:5px; color:black;border-top:0px;">
					<tr>
						<td style="width:854px;text-align:left;padding-left:224px;font-weight:bold;">
