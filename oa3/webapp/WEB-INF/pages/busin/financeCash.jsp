  ...
  <head>
	...
	<script type="text/javascript">
		...
		function confirmCash(){
			if (confirm("是否确认回款？")){
				document.getElementById("editForm").action = "${ctx}/busin/ConfirmCash.action";
				document.getElementById("editForm").submit();
			}
		}
								...
								<s:else>
									<td style="width:200px;">
											...
											<input type="text" id="CRemarks2<s:property value="#anum.index" />" 
													...
													class="" style="width:196px;border:0px;"/>
											<input type="hidden"
				...
				<table>
					<tr>
						<td colspan="8" style="padding-top:20px; padding-bottom:20px;">
							<input type="button" value="打印回款单" style="float:left; width:80px;height:25px;margin-left:380px;" onclick="printCash();"/>
							<input type="button" value="回款确认" style="float:left; width:80px;height:25px;margin-left:20px;" onclick="confirmCash();"/>
