  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			var eid = "${requestScope.businSumReportQuery.eid}";
		...
		function forward(flag){
			document.getElementById("queryForm").action = "${ctx}/busin/BusinSumReport.action";
			//首页
			if (flag == 1){
				...
				<table style="width:850px; margin-left:0;">
					<tr>
						...
						<td style="text-align:left; width:90px;">
	  					...
	  					<td style="width:70px;">制单人</td>
						<td style="width:150px;text-align:left; ">
							<select id="eid" name="businSumReportQuery.eid" class="border" style="width:150px;border:1px solid lightblue;">
		            ...
		            <s:iterator value="#request.businList" var="businList" status="num">
					    <s:if test="black == 1">
			           	...
			           	<s:else>
							...
							<td><s:property value="shipment"/></td>
