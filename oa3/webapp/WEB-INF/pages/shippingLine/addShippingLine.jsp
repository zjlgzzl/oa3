...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		//返回
		function returnList(){
			document.getElementById("editForm").action = "${ctx}/shippingLine/ShippingLineList.action";
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/shippingLine/SaveShippingLine.action" method="post">
	  				<div>
			           	<label><span style="color:red;">*</span>ShippingLine</label>
