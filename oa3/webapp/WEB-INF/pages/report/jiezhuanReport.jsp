  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			var cusid = "${requestScope.queryJiezhuan.TBusin.TCustomerByCCusid.CId}";
		...
		function forward(flag){
			document.getElementById("queryForm").action = "${ctx}/report/JiezhuanReport.action";
			//首页
			if (flag == 1){
		...
		function cancalNotice(businId){
			var url="${ctx}/report/CancelJiezhuanNotice.action";
				...
				<table style="width:1980px; margin-left:0;">
					<tr>
						...
						<td style="width:470px;text-align:left; ">
							<select id="cusid" name="queryJiezhuan.TBusin.TCustomerByCCusid.CId" 
						...
						<td style="width:120px;text-align:left; ">
							<input id="billNo" name="queryJiezhuan.TBusin.CBillNo" value="${requestScope.queryJiezhuan.TBusin.CBillNo}" 
	        ...
	        <div class="right_3">
		        <table id="table1" class="table" style="width:880px;">
		           	<tr>
		           		...
		           		<th style="width:180px;">业务单</th> 
		               	<th style="width:280px;">客户</th>
		               	<th style="width:130px;">原始数据</th>
		               	<th style="width:130px;">修改数据</th>
		            ...
		            <s:iterator value="#request.reportList" var="reportList" status="num">
			            <tr>
							...
							<td>
								<a href="javascript:void(0);" onclick="cancalNotice(<s:property value="TBusin.CId"/>);">取消提醒</a>
							</td>
						</tr>
		            </s:iterator>
		       </table>
