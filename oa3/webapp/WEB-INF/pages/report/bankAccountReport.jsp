...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div class="right">
  		<div class="right_1">
			<form id="queryForm" action="${ctx}/report/BankAccountReport.action" method="post">
        ...
        <div class="right_3">
	        <table id="table1" class="table" style="width:750px;">
	           	<tr>
	               	...
	               	<th style="width:260px;">银行名称bank name</th>
	               	<th style="width:150px;">期初余额</th>
	               	<th style="width:150px;">本期收入</th>
	               	<!--  
	               	<th style="width:100px;">临时支出总计</th>
	               	<th style="width:100px;">永久支出总计</th>
	               	-->
	               	<th style="width:150px;">本期支出</th>
	               	<th style="width:150px;">期末余额</th>
	            ...
	            <s:iterator value="#request.bankList" var="bankList" status="num">
		            <tr>
						...
						<td>
							<fmt:formatNumber type="number" value="${beginMoney}" pattern="###.00" />
						</td>
						<td>
						...
						<td>
							<fmt:formatNumber type="number" value="${beginMoney + endMoney}" pattern="###.00" />
						</td>
					</tr>
	            </s:iterator>
	       </table>
