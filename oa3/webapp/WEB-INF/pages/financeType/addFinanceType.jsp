 			...
 			<form id="editForm" action="${ctx}/financeType/SaveFinanceType.action" method="post">
  				<table style="width:720px;">
  					...
  					<tr style="height:50px;">
  						...
  						<td style="width:600px;text-align:left;">
  							<textarea id="remarks" name="financeType.CRemarks" rows="5" cols="10" style="width:180px;">${requestScope.financeType.CRemarks}</textarea>
  						</td>
  					</tr>
  				</table>
		        ...
		        <div style="margin:10px;">
		           	<input type="button" value="保存" class="save" style="width:60px;height:20px;margin-left:120px;" onclick="check();"/>
