...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
			<form id="editForm" action="${ctx}/busin/SaveFinanceGroup.action" method="post">
				...
				<table id="mainTable" class="table" style="margin-top:30px; width:550px; margin-left:5px;">
					<tr>
						<td style="width:150px;">
							<span style="color:red;">*</span><label style="color:black;">回款项目组名称</label>
						</td>
						<td style="width:400px;">
							<input id="cname" name="group.CName" value="${requestScope.group.CName}"
									type="text" class="field border" style="width:385px"/>
					...
					<tbody id="detail">
						<tr>
							...
							<td style="width:410px; border-top:0px;">
								<span style="color:red;">*</span>回款项目
							</td>
