...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/container/UpdateConInfo.action" method="post">
	  				<div>
			           	<label>货柜编号</label>
			           	<input id="CCode" name="conInfo.CCode" value="${requestScope.conInfo.CCode}"
			           			type="text" class="field border" disabled="disabled"/>
			           	<input id="CId" name="conInfo.CId" value="${requestScope.conInfo.CId}"
			           			type="hidden" />
			           	<input id="CState" name="conInfo.CState" value="${requestScope.conInfo.CState}"
			           			type="hidden" />
			           	<input id="CCreateUserid" name="conInfo.CCreateUserid" value="${requestScope.conInfo.CCreateUserid}"
			           			type="hidden" />
			        ...
			        <div>
			           	<label>货柜型号</label>
			           	<select id="TContainerModel" name="conInfo.TContainerModel.CId" class="border" style="width:200px;" disabled="disabled">
			        ...
			        <div>
			           	...
			           	<textarea id="remarks" name="conInfo.CRemarks" rows="5" cols="10" disabled="disabled">${requestScope.conInfo.CRemarks}</textarea>
			        </div>
			        <div style="margin:10px;">
			           	<input type="button" value="返回" class="return" style="margin-left:120px;width:60px;height:20px" onclick="returnList();"/>
			        </div>
		        </form>
	        </div>
        </div>
