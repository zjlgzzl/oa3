...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var type = "${requestScope.computeQuery.opertype}";
			if (type != -1){
  ...
  <body>
  	<div class="right">
  		<div class="right_1">
			<form id="queryForm" action="${ctx}/container/ConComputeList.action" method="post">
					<table style="width:900px; margin-left:0;">
						<tr>
							<td style="width:60px;">日期从</td>
							...
							<td style="width:100px;text-align:left;">
								<input id="cusname" name="computeQuery.cusname" value="${requestScope.computeQuery.cusname}" 
										type="text" class="field border" style="width:100px;" />
		  					</td>
							<td style="width:100px;">货柜编号</td>
							<td style="width:100px;text-align:left;">
								<input id="infoCode" name="computeQuery.infoCode" value="${requestScope.computeQuery.infoCode}" 
										type="text" class="field border" style="width:100px;" />
		  					</td>
		  					<td style="width:100px;">货柜状态</td>
		  					<td style="width:100px;text-align:left;">
								<select id="COpertype" name="computeQuery.opertype" class="border" style="width:100px;">
        ...
        <div class="right_3">
	        <table id="table1" class="table" style="width:1000px;">
	           	<tr>
	               	...
	               	<th style="width:80px;">成本价格</th>
	               	<th style="width:80px;">金额</th>
	               	<th style="width:120px;">经手人</th>
	               	<th style="width:200px;">备注</th>
	            </tr>
	            <s:iterator value="#request.computeList" var="computeList" status="num">
	            <tr>
					...
					<td><s:property value="opertypeName"/></td>
	    ...
	    <div class="right_4" style="margin-top:10px;">
	    	<div style="float:left; margin-left:5px; font-weight:bold;">
           		货柜总成本：${requestScope.i}
           	</div>
           	<div style="float:left; margin-left:60px; font-weight:bold;">
           		出租总费用：${requestScope.j}
           	</div>
           	<div style="float:left; margin-left:60px; font-weight:bold;">
           		出售总费用：${requestScope.k}
           	</div>
           	<div style="float:left; margin-left:60px; font-weight:bold;">
           		货柜总利润：${requestScope.l}
           	</div>
	    </div>
	    <div class="clear"></div>
       <div class="right_4" style="margin-top:15px;">
