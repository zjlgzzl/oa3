...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		//返回
		function returnList(){
			document.getElementById("editForm").action = "${ctx}/hscode/HsCodeList2.action";
  	...
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit" style="margin-top:10px;margin-left:20px;">
  				<form id="editForm" action="${ctx}/hscode/UpdateHscode2.action" method="post">
	  				<div>
			           	...
			           	<input type="hidden" name="entity.CType" value="2" />
			           	<input type="hidden" name="entity.CId" value="${requestScope.entity.CId}" />
			           	<input type="hidden" name="entity.TUser.CId" value="${requestScope.entity.TUser.CId}" />
			           	<input type="hidden" name="entity.CCreateDate" value="${requestScope.entity.CCreateDate}" />
			        ...
			        <div>
			        	<label><span style="color:red;">*</span>Unit</label>
			           	<input id="CUnit" 
			           			name="entity.CUnit" 
			        ...
			        <div>
			           	<label>备注</label>
			           	<textarea id="remarks" name="entity.CRemarks" rows="5" cols="10">${requestScope.entity.CRemarks}</textarea>
			        </div>
