...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="mainContent">
  		<div class="right">
  			<div class="edit">
  				<form id="editForm" action="${ctx}/bank/UpdateBank.action" method="post">
	  				<div>
			        ...
			        <div>
			           	...
			           	<textarea id="remarks" name="bank.CRemarks" rows="5" cols="10">${requestScope.bank.CRemarks}</textarea>
			        </div>
