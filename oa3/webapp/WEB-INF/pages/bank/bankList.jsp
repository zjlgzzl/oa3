...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		function add(){
			document.getElementById("queryForm").action = "${ctx}/bank/AddBank.action";
			document.getElementById("queryForm").submit();
		}
	</script>
  </head>
  <body>
  	<div class="right">
  		<div class="right_1">
			<form id="queryForm" action="${ctx}/bank/BankList.action" method="post">
	            ...
	            <tr>
					...
					<td>
						<s:if test="(CState == 1) && (CCreateUserid==#session.userID)">
							<a href="${ctx}/bank/EditBank.action?id=<s:property value="CId"/>">修改</a>
							<a href="${ctx}/bank/DeleteBank.action?id=<s:property value="CId"/>"
								onclick="return confirmDel();">删除</a>
						</s:if>
						<a href="${ctx}/bank/ViewBank.action?id=<s:property value="CId"/>">查看</a>
					</td>
				</tr>
	            </s:iterator>
	       </table>
