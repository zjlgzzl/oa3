...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		//添加
		function add(){
			document.getElementById("queryForm").action = "${ctx}/dept/AddDept.action";
			document.getElementById("queryForm").submit();
		}
		//修改
		function edit(cid){
			document.getElementById("cid").value = cid;
			document.getElementById("queryForm").action = "${ctx}/dept/EditDept.action";
			document.getElementById("queryForm").submit();
		}
		//查看
		function view(cid){
			document.getElementById("cid").value = cid;
			document.getElementById("queryForm").action = "${ctx}/dept/ViewDept.action";
			document.getElementById("queryForm").submit();
		}
		//删除确认
		function confirmDel(cid){
			if (confirm("删除的数据将无法恢复，是否确认删除？")){
				document.getElementById("cid").value = cid;
				document.getElementById("queryForm").action = "${ctx}/dept/DeleteDept.action";
				document.getElementById("queryForm").submit();
			}
			return false;
		}
  ...
  <body>
  	<div class="right">
  		<div class="right_1">
			<form id="queryForm" action="${ctx}/dept/DeptList.action" method="post">
					<table style="width:510px; margin-left:0;">
						<tr>
							<td style="width:70px;">部门编号</td>
        ...
        <div class="right_3">
	        <table id="table1" class="table">
	           	<tr>
	               	...
	               	<th style="width:180px;">部门名称</th>
	               	<th style="width:80px;">状态</th>
	               	<th style="width:210px;">备注 </th>
	                <th style="width:190px;">操作</th>
	            </tr>
	            <s:iterator value="#request.deptList" var="deptList" status="num">
	            <tr>
